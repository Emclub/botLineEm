...
def listgrup():
    listGrup =  """🚨คำสั่งตั้งค่า เอ็ม Bot Self🚨
...
def socmedia():
    socMedia = """💌คำสั่งแทค เอ็ม Bot Self💌
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    line.sendMessage(to, "เอ็ม Bot Self กำลังโหลด:▒...0%")
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["แทค"]:
                    line.sendText(msg.to,"เอ็มขออณุญาติแทคนะครับ")				
