...
🍂 ลิ้ง ➠ ขอลิ้งกลุ่ม
🍂 MIDกลุ่ม  ➠ ดูมิดกลุ่มที่เราอยู่ทุกกลุ่ม
🍂 แทค ➠ แทคคนในกลุ่ม
⛅ ตั้งเวลา ➠ ตั้งเวลา
⛅ ปิดเวลา ➠ ปิดเวลา
⛅ รีเวลา ➠ ลบเวลาคนอ่าน
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    line.sendMessage(to, " 🔱เอ็ม Bot Self ยังอยู่คร้าบบ✅")
...
#==============================================================================#   
                    ...
                    for k in range(0, len(bulan)):
                        if bln == str(k): bln = bulan[k-1]
                    readTime = hasil + ", " + timeNow.strftime('%d') + " - " + bln + " - " + timeNow.strftime('%Y') + "\nเวลาการทำงาน : [ " + timeNow.strftime('%H:%M:%S') + " ]"
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["me","คท","Me",".คท","!me","/me"]:
                    line.sendText(msg.to,"เช็คทั้งวันทั้งคืน555")
                ...
                if RfuCctv['cyduk'][op.param1]==True:
                    if op.param1 in RfuCctv['point']:
                        ...
                        if Name in RfuCctv['sidermem'][op.param1]:
                            ...
                            pref=['สวัสดีครับคนอ่าน⏩','ตร๊ะ!..เอ๋!!..😝','หวัดดีจร้า💖','เอ็มเห็นนะ อิอิ..😝','ห้ามแอบ มาคุยด้วยหน่อย⏩','แอบแฟนเล่นหราา💨','เอ็มรู้นะว่าคัยอ่าน👉','เล่นซ่อนแอบหรอคร้าบบ👻','มาคุยกับเค้าหน่อย⏩','นั่นแน่ แอบหราาา😎']
